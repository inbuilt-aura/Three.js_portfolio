...
const FeedbackCard = ({
  ...
  <motion.div
    ...
    className="bg-black-100 p-10 rounded-3xl xs:w-[300px] w-full"
  >
...
const Feedbacks = () => {
  return (
    <div className={`mt-12 bg-black-200 rounded-[10px]`}>
      <div
        className={`bg-tertiary rounded-3xl ${styles.padding} min-h-[300px]`}
      >
